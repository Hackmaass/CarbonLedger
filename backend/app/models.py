...
class BlockchainInfo(BaseModel):
    """Integrity proof for a footprint entry."""
...
class EntryCreate(BaseModel):
    ...
    device_id: str = Field(pattern=r"^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$")
    input: CarbonInput
...
class Entry(EntryCreate):
    ...
    blockchain: BlockchainInfo | None = None
